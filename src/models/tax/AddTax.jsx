...
const AddTax = ({ isOpen, onClose }) => {
  ...
  const handleAddTax = useMutation({
    mutationKey: ["new-tax"],
    mutationFn: (formData) => createNewTax(formData, navigate),
    ...
    onSuccess: () => {
      ...
      toaster.create({
        title: "Success",
        description: "New tax created successfully",
        type: "success",
      });
    },
    onError: () => {
      toaster.create({
        title: "Error",
        description: "Error in creating new tax",
        type: "error",
      });
    },
  });
  ...
  return (
    ...
    >
      <DialogContent>
        ...
        <DialogHeader>
          <DialogTitle className="font-[600] text-[18px]">Add Tax</DialogTitle>
        </DialogHeader>
          ...
          {showLoading ? (
            ...
            <div className="flex flex-col gap-4 justify-between">
              ...
              <div className="flex justify-end gap-4">
                ...
                <button
                  onClick={() => handleAddTax.mutate(formData)}
                  className="bg-teal-800 rounded-lg px-6 py-2 text-white font-semibold justify-end"
                >
                  {handleAddTax.isPending ? `Saving...` : `Save`}
                </button>
              </div>
            </div>
          )}
