...
const AddIndividualBanner = ({ isOpen, onClose }) => {
  ...
  const handleAddBanner = useMutation({
    ...
    mutationFn: (bannerData) => createNewIndividualBanner(bannerData, navigate),
    onSuccess: () => {
...
export default AddIndividualBanner;
